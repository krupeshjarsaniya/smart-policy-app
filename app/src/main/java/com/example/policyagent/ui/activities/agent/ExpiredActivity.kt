...
class ExpiredActivity : BaseActivity(), KodeinAware, ExpiredListListener {
    override val kodein by kodein()
    private val factory: MainViewModelFactory by instance()
    private var binding: ActivityExpiredBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_expired)
        ...
        binding!!.appBar.tvTitle.text = resources.getString(R.string.expired_policy_lbl)
            ...
            ViewTreeObserver.OnScrollChangedListener {
                ...
                val diff: Int =
                    view.bottom - (binding!!.nestedScrollView.getHeight() + binding!!.nestedScrollView
                        .scrollY)
                if (diff == 0 && hasMore) {
                    viewModel!!.getExpiredInsurance(this, page)
                }
            })

...
import com.example.policyagent.databinding.ActivityPaymentDuePolicyBinding
...
class PaymentDuePolicyActivity : BaseActivity(), KodeinAware, ExpiredListListener {
    override val kodein by kodein()
    private val factory: MainViewModelFactory by instance()
    private var binding: ActivityPaymentDuePolicyBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_payment_due_policy)
        ...
        binding!!.appBar.tvTitle.text = resources.getString(R.string.payment_due_policy)
            ...
            ViewTreeObserver.OnScrollChangedListener {
                ...
                val diff: Int =
                    view.bottom - (binding!!.nestedScrollView.getHeight() + binding!!.nestedScrollView
                        .scrollY)
                if (diff == 0 && hasMore) {
                    viewModel!!.getPaymentDueInsurance(this, page)
                }
            })

...
import com.example.policyagent.databinding.ActivityUpcomingPaymentPolicyBinding
...
class UpcomingPaymentPolicyActivity : BaseActivity(), KodeinAware, ExpiredListListener {
    override val kodein by kodein()
    private val factory: MainViewModelFactory by instance()
    private var binding: ActivityUpcomingPaymentPolicyBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_upcoming_payment_policy)
        ...
        binding!!.appBar.tvTitle.text = resources.getString(R.string.upcoming_payment_policy)
            ...
            ViewTreeObserver.OnScrollChangedListener {
                ...
                val diff: Int =
                    view.bottom - (binding!!.nestedScrollView.getHeight() + binding!!.nestedScrollView
                        .scrollY)
                if (diff == 0 && hasMore) {
                    viewModel!!.getUpcomingPaymentInsurance(this, page)
                }
            })
